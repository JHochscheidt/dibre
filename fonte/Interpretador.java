...
class Interpretador {
    ...
    public void interpretaLinha(String linha, int i){
    	...
    	if(linha.matches(declaracaoDeVariavel)){
    		...
    		if(this.declararVariavel(tokens.get(0)) == null){
    		 ...
    		 * 
    		 * 
    		 * parei aqui, fazer agora declaracao de variavel com tribuicao
    		 * 
    		 * 
    		 * 
    		 * 
    		...
    		System.out.println("declaracao de variavel com atribuicao");
    	}else{
    ...
    public boolean declararVariavelComAtribuicao(String nome, double valor){
    	if(declararVariavel(nome) != null){
    		Variavel newVar = declararVariavel(nome);
    ...
    //chama metodo que vai tentar declarar variavel sem atribuicao
    public Variavel declararVariavel(String nome){
    	if(!verificaSeExisteVariavel(nome)){
    		//System.out.println("declarando variavel..." + nome);
